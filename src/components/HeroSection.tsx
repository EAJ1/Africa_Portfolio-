          ...
          >
            ...
            >
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-3 text-base transition-all duration-300 hover:from-purple-700 hover:to-blue-700"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
              ...
              <motion.button
                className="rounded-full border border-purple-500/50 px-6 py-3 text-base backdrop-blur-sm transition-all duration-300 hover:border-purple-500"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
