    ...
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden scroll-mt-0">
      ...
      <div className="container mx-auto px-6 z-10 relative">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            >
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex w-fit items-center justify-center gap-2 rounded-full bg-gradient-to-r from-purple-600 to-blue-600 px-5 py-2.5 text-sm transition-all duration-300 hover:from-purple-700 hover:to-blue-700"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
              ...
              <motion.button
                className="inline-flex w-fit items-center justify-center rounded-full border border-purple-500/50 px-5 py-2.5 text-sm backdrop-blur-sm transition-all duration-300 hover:border-purple-500"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
          ...
          >
            <motion.div
              className="relative w-64 sm:w-72 md:w-80 h-64 sm:h-72 md:h-80 mx-auto perspective-1000"
            ...
            >
              ...
              >
                <TypewriterText
                  ...
                  speed={100}
                  className="inline-block text-xl sm:text-2xl font-semibold bg-gradient-to-r from-purple-600 via-blue-500 to-purple-800 bg-clip-text text-transparent"
                  style={{
