          ...
          {categories.map((category, categoryIndex) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-lg sm:text-xl md:text-2xl mb-4 sm:mb-6 text-purple-600 dark:text-purple-400">
                  {category}
                </h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
                  {categorySkills.map((skill, skillIndex) => (
                    <motion.div
                      key={skill.name}
                      className="relative p-3 sm:p-4 md:p-6 rounded-2xl backdrop-blur-lg border border-white/20 hover:border-white/40 transition-all duration-300 group"
                      style={{
                        background: isDark 
                    ...
                    >
                      {/* Skill circle */}
                      <div className="relative w-12 sm:w-16 md:w-20 h-12 sm:h-16 md:h-20 mx-auto mb-3 sm:mb-4">
                        <svg className="w-12 sm:w-16 md:w-20 h-12 sm:h-16 md:h-20 transform -rotate-90" viewBox="0 0 32 32">
                          {/* Background circle */}
                          <circle
                            cx="16"
                            cy="16"
